...
> Project status: working prototype for Casio FZ-series hardware. The firmware renders correctly on tested FZ hardware, including Deftaudio PCB testing on FZ-1, FZ-10 / FZ-20 units. Related VZ-series support is planned for a future update but is not implemented yet. More long-term testing is still in progress. Please report any observed issues or unwanted behaviour.
